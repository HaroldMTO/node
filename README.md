...
- executable files (ie shell scripts) are located by variable B (eg B=~/bin as in this Makefile)
- side files (R scripts, HTML files, etc) are referenced by variable P (eg P=$(HOME)/proc as in this Makefile)
...
Please download the tarball preferentially. Then proceed to the desired installation by way of this command (other means exist, cf R web site):
